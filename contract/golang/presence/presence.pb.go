...
type GetPresenceRequest struct {
	...
	UserIds []int64 `protobuf:"varint,1,rep,packed,name=user_ids,json=userIds,proto3" json:"user_ids,omitempty"` //means repeated => array
}
...
func (x *GetPresenceRequest) GetUserIds() []int64 {
	if x != nil {
		return x.UserIds
	}
	return nil
